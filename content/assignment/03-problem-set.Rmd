...
- Submit your homework as an RMarkdown document (the `LASTNAME-FIRSTNAME-HW02.Rmd` file), as well as knitted PDF or Word document (the `LASTNAME-FIRSTNAME-HW02.pdf` file). Make sure that the knitted version shows both the code chunks and their output.